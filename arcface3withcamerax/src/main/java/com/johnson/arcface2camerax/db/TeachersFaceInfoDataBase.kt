...
abstract class TeachersFaceInfoDataBase : RoomDatabase() {
...
//                database.execSQL("alter table  aaaa rename to Userjava")
        ...
        @Volatile
        private var instance: TeachersFaceInfoDataBase? = null

        fun getDBInstace(context: Context): TeachersFaceInfoDataBase {

            if (instance == null) {

                synchronized(TeachersFaceInfoDataBase::class) {

                    if (instance == null) {

                        instance = Room.databaseBuilder(
                                context.applicationContext,
                                TeachersFaceInfoDataBase::class.java,
