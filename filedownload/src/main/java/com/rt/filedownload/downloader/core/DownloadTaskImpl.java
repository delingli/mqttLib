...
import com.rt.filedownload.downloader.core.task.GetFileInfoTask;
import com.rt.filedownload.downloader.core.task.GetFileInfoTask.OnGetFileInfoListener;
import com.rt.filedownload.downloader.core.thread.DownloadThread;
import com.rt.filedownload.downloader.core.thread.DownloadThread.DownloadProgressListener;
...
public class DownloadTaskImpl implements DownloadTask, OnGetFileInfoListener,
    ...
    public void onFailed(DownloadException exception) {
        Log.d("DownloadTaskImpl", "exception:" + exception);
    }
