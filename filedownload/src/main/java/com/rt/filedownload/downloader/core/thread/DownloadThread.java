package com.rt.filedownload.downloader.core.thread;
...
import com.rt.filedownload.downloader.exception.DownloadPauseException;
...
public class DownloadThread implements Runnable {
    ...
    private void executeDownload() {
        ...
        try {
            final URL url = new URL(/*"http://10.10.20.178" +*/ downloadThreadInfo.getUri());
